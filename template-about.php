    ...
    <main>
        ...
        <section class="about-two-area pt-120">
            <div class="about-two__shape">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/about-two-shape.png" alt="shape">
            </div>
            <div class="container">
                <div class="row g-4">
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about-two__left-item">
                            <div class="dots">
                                <img class="sway_Y__animation" src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/about-two-dot.png" alt="shape">
                            </div>
                            <div class="shape-halper">
                                <img class="sway__animation" src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/about-circle-helper.png"
                                    alt="shape">
                            </div>
                            <div class="image big-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/about-two-image1.jpg" alt="image">
                            </div>
                            <div class="image sm-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/about-two-image2.png" alt="image">
                            </div>
                            <div class="circle-shape">
                                <img class="animation__rotate" src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/about-two-circle.png"
                                    alt="shape">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        ...
                        <div class="about__info mt-50 wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            ...
                            <img src="<?php echo get_template_directory_uri(); ?>/ssets/images/about/singature.png" alt="singature">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="offer-area secondary-bg pt-120 pb-200">
            <div class="offer__shadow wow fadeIn" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/offer-shadow-shape.png" alt="shadow">
            </div>
            <div class="offer__shape-left">
                <img class="wow fadeInUpBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/offer-bg-shape-left.png" alt="shape">
            </div>
            <div class="offer__shape-right">
                <img class="wow fadeInDownBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/offer-bg-shape-right.png" alt="shape">
            </div>
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="00ms"
                        ...
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/offter-item-shape-top.png" alt="shape">
                            </div>
                            <div class="shape-bottom">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/offter-item-shape-bottom.png" alt="shape">
                            </div>
            ...
            <div class="container">
                <div class="brand__wrp">
                    <div class="brand__shape">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/brand-shape.png" alt="">
                    </div>
                    <div class="swiper brand__slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-image1.png" alt="image">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-image2.png" alt="image">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-image3.png" alt="image">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-image4.png" alt="image">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-image5.png" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
