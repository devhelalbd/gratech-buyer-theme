<section class="about-area sub-bg pt-120">
            <div class="about__shape wow slideInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/about-line.png" alt="shape">
            </div>
            <div class="container">
                <div class="row g-4">
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about__left-item">
                            <div class="image big-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/about-image1.jpg" alt="image">
                            </div>
                            <div class="image sm-image">
                                ...
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/about-image2.png" alt="image">
                            </div>
                            <div class="circle-shape">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/about-circle.png" alt="shape">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="section-header mb-40">
                            <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <img class="me-1" src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/section-title.png" alt="icon">
                                ABOUT Gratech
                            </h5>
                        ...
                        <div class="row g-4 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/about-icon1.png" alt="icon">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/about-icon2.png" alt="icon">
                                    </div>
                                    <div class="content">
                        ...
                        <div class="about__info mt-50 wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/about-info.png" alt="image">
                                <div class="info">
