                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="process__item mb-100">
                            <div class="process-arry bobble__animation">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/process/process-arry.png" alt="arry-icon">
                            </div>
                            <div class="process__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/process/process-image1.png" alt="image">
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="process__item mb-100">
                            ...
                            <div class="process__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/process/process-image2.png" alt="image">
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="process__item">
                            <div class="process__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/process/process-image3.png" alt="image">
