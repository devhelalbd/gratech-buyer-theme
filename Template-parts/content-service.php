<section class="service-area pt-120 pb-120">
            <div class="service__shape wow slideInRight">
                <img class="sway_Y__animation" src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/service-bg-shape.png" alt="shape">
            </div>
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            <div class="service-shape">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shape/service-item-shape.png" alt="shape">
                            </div>
                            <div class="service__icon">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/service-icon1.png" alt="icon">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <div class="service__item active">
                            ...
                            <div class="service__icon">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/service-icon2.png" alt="icon">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <div class="service__icon">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/service-icon3.png" alt="icon">
                            </div>
