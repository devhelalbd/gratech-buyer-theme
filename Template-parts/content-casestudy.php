            ...
            <div class="swiper case__slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/case/case-image1.jpg" alt="image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/case/case-image2.jpg" alt="image">
                            </div>
                            <div class="case__content">
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/case/case-image3.jpg" alt="image">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Solution</span>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/case/case-image4.jpg" alt="image">
                            </div>
                            <div class="case__content">
