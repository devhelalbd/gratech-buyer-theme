<section class="testimonial-area bg-image pt-120 pb-120" data-background="<?php echo get_template_directory_uri(); ?>/assets/images/bg/testimonial-bg.png">
            <div class="container">
                <div class="row g-4">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonial/testimonial-image1.png" alt="image">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonial/testimonial-image2.png" alt="image">
                                            <div class="testi-info">
                                                <h4>Alex Rony</h4>
                                                <p>Web Designer</p>
                                                <div class="star mt-1">
