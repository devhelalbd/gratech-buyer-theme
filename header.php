        ...
        <div class="container header__container">
            <div class="header__main">
                <a href="index.html" class="logo">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo/logo-light.svg" alt="logo">
                </a>
                <div class="main-menu">
                    <nav>
                        <ul>
                                ...
                                <ul class="sub-menu mega-menu menu-image">
                                    <li>
                                        <div class="image text-center">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu/home1-image.jpg" alt="image">
                                        ...
                                        <div class="image text-center">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu/home2-image.jpg" alt="image">
                                            <div class="btn__group">
                                        ...
                                        <div class="image text-center">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu/home3-image.jpg" alt="image">
                                            <div class="btn__group">
                                        ...
                                        <div class="image text-center">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu/home4-image.jpg" alt="image">
                                            <div class="btn__group">
