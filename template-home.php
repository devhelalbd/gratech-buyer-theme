...
get_header(); ?>
    ...
    <main>
        ...
        <?php get_template_part('template-parts/content', 'workprocess'); ?>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image d-block image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-image1.jpg" alt="image">
                                <div class="blog-tag">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image image d-block">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-image2.jpg" alt="image">
                                <div class="blog-tag">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image image d-block">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-image3.jpg" alt="image">
                                <div class="blog-tag">
